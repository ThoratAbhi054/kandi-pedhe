...
const footerNavigation = {
  shop: [
    { id: 1, name: "Bags", href: "#" },
    { id: 2, name: "Tees", href: "#" },
    { id: 3, name: "Objects", href: "#" },
    { id: 4, name: "Home Goods", href: "#" },
    { id: 5, name: "Accessories", href: "#" },
  ],
  company: [
    { id: 1, name: "Who we are", href: "#" },
    { id: 2, name: "Sustainability", href: "#" },
    { id: 3, name: "Press", href: "#" },
    { id: 4, name: "Careers", href: "#" },
    { id: 5, name: "Terms & Conditions", href: "#" },
    { id: 6, name: "Privacy", href: "#" },
  ],
  account: [
    { id: 1, name: "Manage Account", href: "#" },
    { id: 2, name: "Returns & Exchanges", href: "#" },
    { id: 3, name: "Redeem a Gift Card", href: "#" },
  ],
  connect: [
    { id: 1, name: "Contact Us", href: "#" },
    { id: 2, name: "Facebook", href: "#" },
